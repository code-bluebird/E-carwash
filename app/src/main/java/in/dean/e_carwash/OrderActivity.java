...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("Orders")
                .orderByChild("email").equalTo(finalemail);
        databaseReference.keepSynced(true);
        options=new FirebaseRecyclerOptions.Builder<Aorders>().setQuery(databaseReference.orderByChild("email").equalTo(finalemail),Aorders.class).build();
            ...
            adapter = new FirebaseRecyclerAdapter<Aorders, FirebaseViewHolder>(options) {
                ...
                protected void onBindViewHolder(@NonNull final FirebaseViewHolder holder, int position,@NonNull final Aorders model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(OrderActivity.this, OrderHomeActivity.class);
                ...
                public FirebaseViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                    ...
                    return new FirebaseViewHolder(LayoutInflater.from(OrderActivity.this).inflate(R.layout.admin_row, viewGroup, false));
                }
            };
