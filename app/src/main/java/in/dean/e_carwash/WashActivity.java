...
public class WashActivity extends AppCompatActivity {
    ...
    private static final String TAG = WashActivity.class.getSimpleName();
     ...
     */
    private WashActivity.AddressResultReceiver mResultReceiver;
...
*/
        mResultReceiver = new WashActivity.AddressResultReceiver(new Handler());
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                proceedCheck(location,address1,address2);
               /* Toast.makeText(WashActivity.this, location, Toast.LENGTH_SHORT).show();
                Toast.makeText(WashActivity.this, address1, Toast.LENGTH_SHORT).show();
                Toast.makeText(WashActivity.this, address2, Toast.LENGTH_SHORT).show();*/
                if(count.equals(true))
                {
                    Intent intent=new Intent(WashActivity.this,WashListActivity.class);
    ...
    private void displayAddressOutput() {
        ...
        /*countt=++count;
        Toast.makeText(this, countt, Toast.LENGTH_SHORT).show();*/
    }
    ...
    private class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == Constants.SUCCESS_RESULT) {
                ...
                /*countt=++count;
                Toast.makeText(WashActivity.this, countt, Toast.LENGTH_SHORT).show();*/
            }
        ...
        if (shouldProvideRationale) {
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(WashActivity.this,
    ...
    public void proceedCheck(String l,String a1,String a2)
    {

        if ((l.isEmpty()) || (a1.isEmpty() )||(a2.isEmpty())||(a1.length()<=1)||(a2.length()<=4))
        {
            if (l.isEmpty())
                Toast.makeText(this, l, Toast.LENGTH_SHORT).show();
            if (a1.isEmpty()||a1.length()<=1)
                Toast.makeText(this, "Enter correct flat number more than 1 characters", Toast.LENGTH_SHORT).show();
            if (a2.isEmpty()||a2.length()<=4)
                Toast.makeText(this, "Enter correct street name more than 4 characters", Toast.LENGTH_SHORT).show();
